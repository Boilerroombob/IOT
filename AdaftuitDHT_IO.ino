...
void loop() {
  ...
  int temperature_data = (int)dht.readTemperature(true);
    ...
    //to prevent occasional erroneous data from DHT being sent to adafruit
   if (humidity_data == 2147483647)
   {goto bailout;}

   if (temperature_data == 2147483647)
   {goto bailout;}
